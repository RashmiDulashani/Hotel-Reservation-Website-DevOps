...
<nav id="nav-bar" class="navbar navbar-expand-lg bg-white px-lg-4 py-lg-1 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 px-3 fw-bold fs-3 h-font" href="index.php"><img src="Images/Logo.jpeg" class="img-fluid me-2" style="width: 45px; height: auto;" alt="Logo">Zenvia</a>
        <button class="navbar-toggler shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse py-sm-3" id="navbarSupportedContent">
            ...
            <div class="d-flex flex-column flex-lg-row align-items-start">
                ...
                <button type="button" class="btn btn-outline-none shadow-none me-2" data-bs-toggle="modal" data-bs-target="#loginModal">
                    <i class="bi bi-person me-2"></i>Login
                </button>
                <button type="button" class="btn btn-outline-none shadow-none" data-bs-toggle="modal" data-bs-target="#registerModal">
